...
public class TestCopyTxt {
    ...
    public void testCopyBy2() throws IOException {
        String pathForm = "src/main/resources/io/stream/OutDemo02.txt";
        String pathTo ="src/main/resources/io/stream/CopyTxtBy2.txt";
    ...
    public void testCopyByBuff() throws IOException {
        String pathForm = "src/main/resources/io/stream/OutDemo02.txt";
        String pathTo ="src/main/resources/io/stream/CopyByBuff.txt";
    ...
    public void testCopyByStream() throws IOException {
        String pathForm = "src/main/resources/io/stream/OutDemo02.txt";
        String pathTo ="src/main/resources/io/stream/CopyByStream.txt";
